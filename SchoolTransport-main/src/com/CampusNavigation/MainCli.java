...
//    logger.debug(NameOfDestination);
    ...
    {
      Route[] myPath=JackYang.position.getNowBuilding().getShortestRoute(JackYang.position,toBuilding(UsrData.get("destination")),UsrData.get("strategy"));
    }else
    {
      Route[] myPath=toPosition(UsrData.get("start")).getNowBuilding().getShortestRoute(toPosition(UsrData.get("start")),toBuilding(UsrData.get("destination")),UsrData.get("strategy"));
    }
  }
